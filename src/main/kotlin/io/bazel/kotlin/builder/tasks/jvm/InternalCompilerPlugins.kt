...
class InternalCompilerPlugins constructor(
  ...
  constructor(
    ...
    jvmAbiGen = InternalCompilerPlugin(jvmAbiGen.jarPath, jvmAbiGen.id),
    skipCodeGen = InternalCompilerPlugin(skipCodeGen.jarPath, skipCodeGen.id),
    kapt = InternalCompilerPlugin(kapt.jarPath, kapt.id),
    jdeps = InternalCompilerPlugin(jdeps.jarPath, jdeps.id),
  )
